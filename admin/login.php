...
<body>
    ...
    if (isset($_POST['signin'])) {
        $query = "SELECT * FROM admins WHERE userid='$_POST[userid]' AND pass='$_POST[password]'";
        $result = mysqli_query($conn, $query);
        $row = mysqli_fetch_array($result);
        if (mysqli_num_rows($result) == 1) {
            session_start();
            $_SESSION['adminUsId'] = $_POST['userid'];
                ...
                <div class="col-lg-6">
                    <div class="card1 pb-5">
                        ...
                        <div class="row px-3 justify-content-center mt-4 mb-5 border-line">
                            <h3 style="margin-top: 30px; margin-bottom:100px;">FoodBee Admin Panel Login</h3>
